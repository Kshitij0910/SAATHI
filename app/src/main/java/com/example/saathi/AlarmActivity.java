            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog=new TimePickerDialog(AlarmActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        //Save data
                        /*SharedPreferences.Editor notifyEditor=itemPrefs.edit();
                        notifyEditor.putString(KEY_TIME, mTime);
                        notifyEditor.putString(KEY_REPEAT_TYPE, mRepeatType);
                        notifyEditor.putInt(KEY_REPEAT_NO, Integer.parseInt(mRepeatNo));
                        notifyEditor.putString("repeat_text", "Every " + mRepeatNo + " " + mRepeatType + "(s)");
                        notifyEditor.apply();*/
                        mTimeText.setText(mTime);
