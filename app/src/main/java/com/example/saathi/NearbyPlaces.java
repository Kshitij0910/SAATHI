        ...
        switch (requestCode){
            case REQUEST_LOCATION_CODE:
                if (grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    if (ContextCompat.checkSelfPermission(NearbyPlaces.this, Manifest.permission.ACCESS_FINE_LOCATION) ==PackageManager.PERMISSION_GRANTED){
                        if (client == null){
                    ...
                    Toast.makeText(NearbyPlaces.this,"Permission is required to access Maps!", Toast.LENGTH_SHORT).show();
                }
                return;
        }
    }
    ...
    public void myOnClick(View v){
        ...
        switch (v.getId()) {
            ...
            case R.id.search_hospital:
                ...
                Toast.makeText(NearbyPlaces.this, "Showing Nearby Hospitals...", Toast.LENGTH_LONG).show();
            ...
            case R.id.search_park:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyPlaces.this, "Showing Nearby Parks...", Toast.LENGTH_LONG).show();
