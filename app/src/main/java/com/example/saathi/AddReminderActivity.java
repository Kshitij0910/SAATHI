...
import com.example.saathi.data.AlarmReminderContract;
import com.example.saathi.reminder.AlarmSchedular;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            Log.d("ADD REMINDER", "onCreate: Add Reminder Details");
            ...
            Log.d("ADD REMINDER", "onCreate: Edit Reminder Details");
    ...
    public void setDate(View v){
        ...
        DatePickerDialog dpd=new DatePickerDialog(this, this,  now.get(Calendar.YEAR),
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            new AlarmSchedular().cancelAlarm(getApplicationContext(),mCurrentReminderUri);
            Log.d("ADD REMINDER", "deleteReminder: Reminder deleted");
...
*/
        ...
        Log.d("ADD REMINDER", "saveReminder: Time taken");
        // Check repeat type
        ...
        Log.d("ADD REMINDER", "saveReminder: Notification");
        // Create a new notification
        if (mActive.equals("true")) {
            if (mRepeat.equals("true")) {
                new AlarmSchedular().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri, mRepeatTime);
            } else if (mRepeat.equals("false")) {
                new AlarmSchedular().setAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri);
            }
            Log.d("ADD REMINDER", "saveReminder: Display Alarm Time"+selectedTimestamp);
